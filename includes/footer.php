        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>Md. Nayeem</h3>
                    <p>A passionate Mobile App Developer and ML Enthusiast, dedicated to creating innovative solutions that make a difference.</p>
                ...
                <div class="footer-section">
                    <h4>Connect</h4>
                    <ul>
                        <li>Email: <a href="mailto:nayeem.code@gmail.com">nayeem.code@gmail.com</a></li>
                        <li>Phone: <a href="tel:+8801968199036">+880 1968199036</a></li>
                        <li>Location: <a href="https://maps.app.goo.gl/ugcFr5fCNVEKxpxg6" target="_blank">Khulna, Bangladesh</a></li>
                    </ul>
                </div>
            </div>
